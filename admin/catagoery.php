...
<body>
   ...
   <div id="header-post" class="header-post">
    <div class="container">
        <div class="row">
       <div class="col-md-6">
            <h2 class="text-dark mt-4 ml-3">ALL CATEGORY</h2>
       </div>
       <div class="col-md-6 col-md-offset-3">
            <a href="add-category.php" class="btn btn-new1 btn-light mr-3">ADD CATEGORY</a>
       </div>
        </div>
        <div class="col-md-12">
            ...
            <tbody>
                <tr>
                   ...
                   <td>HTML</td>
                   <td>6</td> 
                   <td><a href="update-category.php"><i class="fa fa-edit"></i></a></td> 
